...
PROMPT_VERSION=v1
########### DO NOT CHANGE ###########
out_dir=/comp_robot/zhanghao/model/llava_stage1_new_gd_refcoco_filtered/
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed llava/train/train_hao_seg_flickr.py \
    ...
    --whole_model /comp_robot/zhanghao/model/llava_stage1_new_gd_flickr_lr_1e-3/checkpoint-4000/ \
    --load_vision True \
    ...
    --opt \
    flickr.TEST.BATCH_SIZE_TOTAL=64,flickr.TRAIN.BATCH_SIZE_TOTAL=64,COCO.TEST.BATCH_SIZE_TOTAL=64,COCO.TRAIN.BATCH_SIZE_TOTAL=64,MODEL.WEIGHTS=/comp_robot/zhanghao/ckpts/openseed_o365.pt \
    >> $out_dir/log 2>&1
