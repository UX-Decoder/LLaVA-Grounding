...
deepspeed llava/train/train_hao_joint2st_interactive_only.py \
    ...
    --opt \
    "detach_seg=True,MODEL.DECODER.WEIGHT_MULTIPLIER=0.1,MODEL.DECODER.COST_CLASS_WEIGHT=4.0,flickr.TEST.BATCH_SIZE_TOTAL=4,flickr.TRAIN.BATCH_SIZE_TOTAL=4,coco_interactive.TRAIN.BATCH_SIZE_TOTAL=4,coco_instruct.TRAIN.BATCH_SIZE_TOTAL=4,MODEL.WEIGHTS=/comp_robot/zhanghao/ckpts/openseed_o365.pt;MODEL.DECODER.WEIGHT_MULTIPLIER=0.1,coco_interactive.TEST.BATCH_SIZE_TOTAL=4,coco_interactive.TRAIN.BATCH_SIZE_TOTAL=4,MODEL.WEIGHTS=/comp_robot/zhanghao/model/idino_llama_coco_ref_feats_fix_all_16im_det_pretrain/model_0084999.pth" \
    >> $out_dir/log 2>&1
