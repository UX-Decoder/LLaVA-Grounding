...
################## LLaMA-2 ##################
out_dir=/comp_robot/zhanghao/model/llava_stage2_new_flickr_mark/
mkdir -p $out_dir
echo $out_dir/log
flickr_im_path=/comp_robot/zhanghao/code/all/GPT4V_eval/gpt4v_data_new_train/flickrv2_gd_id_font_size_20_alpha_0.4_sam_mask/
