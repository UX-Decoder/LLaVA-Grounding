import json
import os
data_dir="/comp_robot/zhanghao/datasets/llava/detailed23k_brackets_out"
data_list=[]
...
for file in tqdm.tqdm(os.listdir(data_dir)):
    ...
    if decide_succ(data):
        ...
        fail+=1
print(succ,fail)
json.dump(fail_ls,open(os.path.join(data_dir,'detailed23k_failed_v2.json'),'w'),indent=4)
json.dump(data_list,open(os.path.join(data_dir,'detailed23k_succ_v2.json'),'w'),indent=4)