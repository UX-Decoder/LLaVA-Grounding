...
refcoco_json='/comp_robot/cv_public_dataset/coco/annotations/refcocog_umd_val.json'
...
with open('/comp_robot/cv_public_dataset/coco/annotations/panoptic_refcocog_umd_val.json','w') as f:
