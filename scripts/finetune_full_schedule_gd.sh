...
#export MASTER_PORT=23412
n_gpus=4
out_dir=/comp_robot/zhanghao/model/llava_stage2_new_gd/
mkdir -p $out_dir
echo $out_dir/log
deepspeed --include=localhost:2,3,4,5 llava/train/train_hao.py \
    --deepspeed scripts/zero3.json \
    --model_name_or_path /comp_robot/zhanghao/ckpts/vicuna/vicuna-7b-v1.3/ \
    --version $PROMPT_VERSION \
    --data_path /comp_robot/zhanghao/datasets/llava/instruct150k_brackets/merged.json \
