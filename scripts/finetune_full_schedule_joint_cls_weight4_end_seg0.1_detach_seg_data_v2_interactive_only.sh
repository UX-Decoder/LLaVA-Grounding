...
################## LLaMA-2 ##################
out_dir=/comp_robot/zhanghao/model/llava_stage2_new_joint_seg0.1_detach_seg_data_v2_interactive_only_rerun_from_st1_fix_opt
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed llava/train/train_hao_joint2st_interactive_only.py \
    ...
    --whole_model /comp_robot/lihongyang/model/llava_stage1_new_flickr_refcoco_llava600k_end_num_fix/checkpoint-18000/ \
    --load_vision True \
