...
PROMPT_VERSION=v1
########### DO NOT CHANGE ###########
out_dir=/comp_robot/zhanghao/model/llava_stage1_new_gd_flickr_continue/
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed --include=localhost:2,3,4,5 --master_port 29503 llava/train/train_hao_seg_flickr.py \
