...
################## LLaMA-2 ##################
out_dir=/comp_robot/zhanghao/model/llava_stage2_new_joint_seg0.1_detach_seg_data_v2_interactive_ref_instr_0.2_continue_instr
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed llava/train/train_hao_joint2st_interactive_only_ref_instr.py \
    ...
    --whole_model /comp_robot/zhanghao/model/llava_stage2_new_joint_seg0.1_detach_seg_data_v2_interactive_ref_instr_0.2/ \
    --load_vision True \
