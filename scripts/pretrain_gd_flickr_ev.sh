...
PROMPT_VERSION=v1
########### DO NOT CHANGE ###########
out_dir=/comp_robot/zhanghao/model/llava_stage1_new_gd_flickr_continue1/
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed --include=localhost:6,7 --master_port 29505 llava/train/train_hao_seg_flickr.py \
    ...
    --report_to wandb \
    --config_file \
    configs/openseed/openseed_swint_lang_flickr_ev.yaml \
    --opt \
