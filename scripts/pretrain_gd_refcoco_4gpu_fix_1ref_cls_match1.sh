...
deepspeed --master_port $port llava/train/train_hao_seg_flickr.py \
    ...
    --opt \
    MODEL.DECODER.COST_CLASS_WEIGHT=1.0,MODEL.DECODER.GROUNDING.MAX_LEN=2,flickr.TEST.BATCH_SIZE_TOTAL=32,flickr.TRAIN.BATCH_SIZE_TOTAL=32,COCO.TEST.BATCH_SIZE_TOTAL=32,COCO.TRAIN.BATCH_SIZE_TOTAL=32,MODEL.WEIGHTS=/comp_robot/zhanghao/ckpts/openseed_o365.pt \
    >> $out_dir/log 2>&1
