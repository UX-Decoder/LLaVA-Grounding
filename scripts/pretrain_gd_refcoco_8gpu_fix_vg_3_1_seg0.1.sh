...
PROMPT_VERSION=v1
########### DO NOT CHANGE ###########
out_dir=/comp_robot/zhanghao/model/llava_stage2_new_gd_refcoco_fixed_vg_3_1_seg0.2/
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed  --master_port $port llava/train/train_hao_seg_flickr.py \
    ...
    --whole_model /comp_robot/zhanghao/model/llava_stage1_new_gd_refcoco_fixed_vg/checkpoint-9000/ \
    --load_vision True \
    ...
    --opt \
    MODEL.DECODER.WEIGHT_MULTIPLIER=0.1,vg.TRAIN.BATCH_SIZE_TOTAL=48,COCO.TEST.BATCH_SIZE_TOTAL=8,COCO.TRAIN.BATCH_SIZE_TOTAL=16,MODEL.WEIGHTS=/comp_robot/zhanghao/ckpts/openseed_o365.pt \
    >> $out_dir/log 2>&1
