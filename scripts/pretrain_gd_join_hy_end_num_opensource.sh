...
PROMPT_VERSION=v1
########### DO NOT CHANGE ###########
out_dir=/comp_robot/lihongyang/model/llava_stage1_new_flickr_refcoco_llava600k_end_num_fix_opensource
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed llava/train/train_hao_joint.py \
    ...
    --whole_model /comp_robot/lihongyang/model/llava_stage1_new_gd_flickr_end_num/ \
    --load_vision True \
    ...
    --opt \
    flickr.TEST.BATCH_SIZE_TOTAL=16,flickr.TRAIN.BATCH_SIZE_TOTAL=16,flickr.gd_mode=end_num,COCO.TEST.BATCH_SIZE_TOTAL=48,COCO.TRAIN.BATCH_SIZE_TOTAL=48,MODEL.WEIGHTS=/comp_robot/zhanghao/ckpts/openseed_o365.pt \
    >> $out_dir/log 2>&1
