...
################## LLaMA-2 ##################
out_dir=/comp_robot/zhanghao/model/llava_stage2_new_joint_seg0.1_detach_seg_data_v2_interleave
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed llava/train/train_hao_joint2st.py \
    ...
    --max_steps 10000 \
    --config_file \
    configs/openseed/openseed_swint_lang_joint_2st_v2_data.yaml \
    --opt \
