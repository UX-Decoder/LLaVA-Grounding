...
PROMPT_VERSION=v1
########### DO NOT CHANGE ###########
out_dir=/comp_robot/zhanghao/model/llava_stage1_new_flickr_refcoco_llava600k_13B_fix
mkdir -p $out_dir
echo $out_dir/log
...
deepspeed llava/train/train_hao_joint.py \
    ...
    --whole_model /comp_robot/zhanghao/model/llava_stage1_new_flickr_refcoco_llava600k_13B/checkpoint-14000/ \
    --load_vision True \
